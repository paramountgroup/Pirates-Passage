...
/*
	...
	User input is also handled by app.js. 
	References for this project were the Udacity discusion board, W3Schools
	Udemy classes, student projects on github (alexx, htm, minkdog, tr12s), Office hours hangouts, recorded office hours,
	stack overflow and youtube.
...
Enemy.prototype.update = function(dt) {
	...
	var randomSpeed = Math.floor((Math.random() * 400) + 1); //randomSpeed is used to make enemies travel different speeds
